...
if (globalThis.__LEAKLOCK_CONTENT_SCRIPT_LOADED__) {
  return;
}
...
chrome.runtime.onMessage.addListener((msg, _sender, sendResponse) => {
  if (msg.type === 'setState') {
    leaklockEnabled = Boolean(msg.enabled);
    if (!leaklockEnabled) closeOverlay();
    sendResponse?.({ enabled: leaklockEnabled });
    return false;
  }
